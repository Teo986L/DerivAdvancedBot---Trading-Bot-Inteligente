...
const dados = {
    '1h': {
        preco: 68000,
        candles: [
            { open: 67900, high: 68100, low: 67800, close: 68000, volume: 1000 },
            { open: 68000, high: 68200, low: 67900, close: 68100, volume: 1200 }
        ]
    },
    '4h': {
        preco: 67950,
...
const SYMBOLS = [
    ...
    { symbol: 'R_25', description: 'Volatility 25 Index' },
    { symbol: 'R_50', description: 'Volatility 50 Index' },
    { symbol: 'R_75', description: 'Volatility 75 Index' },
    { symbol: 'R_100', description: 'Volatility 100 Index' },
    { symbol: 'R_150', description: 'Volatility 150 Index' },
    { symbol: 'R_200', description: 'Volatility 200 Index' },
    { symbol: 'R_250', description: 'Volatility 250 Index' },
    { symbol: '1HZ10V', description: 'Volatility 10 (1s) Index' },
    { symbol: '1HZ25V', description: 'Volatility 25 (1s) Index' },
    { symbol: '1HZ50V', description: 'Volatility 50 (1s) Index' },
    { symbol: '1HZ75V', description: 'Volatility 75 (1s) Index' },
    { symbol: '1HZ100V', description: 'Volatility 100 (1s) Index' },
    { symbol: '1HZ150V', description: 'Volatility 150 (1s) Index' },
    { symbol: '1HZ250V', description: 'Volatility 250 (1s) Index' },
    { symbol: 'BOOM300N', description: 'Boom 300 Index' },
    { symbol: 'BOOM500', description: 'Boom 500 Index' },
    { symbol: 'BOOM600', description: 'Boom 600 Index' },
    { symbol: 'BOOM900', description: 'Boom 900 Index' },
    { symbol: 'BOOM1000', description: 'Boom 1000 Index' },
    { symbol: 'CRASH300N', description: 'Crash 300 Index' },
    { symbol: 'CRASH500', description: 'Crash 500 Index' },
    { symbol: 'CRASH600', description: 'Crash 600 Index' },
    { symbol: 'CRASH1000', description: 'Crash 1000 Index' },
    { symbol: 'stpRNG', description: 'Step Index' },
    { symbol: 'stpRNG2', description: 'Step 200 Index' },
    { symbol: 'stpRNG3', description: 'Step 300 Index' },
    { symbol: 'stpRNG4', description: 'Step 400 Index' },
    { symbol: 'stpRNG5', description: 'Step 500 Index' },
    { symbol: 'frxEURUSD', description: 'Euro vs US Dollar' },
    { symbol: 'frxGBPUSD', description: 'British Pound vs US Dollar' },
    { symbol: 'frxUSDJPY', description: 'US Dollar vs Japanese Yen' },
    { symbol: 'frxUSDCHF', description: 'US Dollar vs Swiss Franc' },
    { symbol: 'frxAUDUSD', description: 'Australian Dollar vs USD' },
    { symbol: 'frxNZDUSD', description: 'New Zealand Dollar vs USD' },
    { symbol: 'frxUSDCAD', description: 'US Dollar vs Canadian Dollar' },
    { symbol: 'frxEURGBP', description: 'Euro vs British Pound' },
    { symbol: 'frxEURJPY', description: 'Euro vs Japanese Yen' },
    { symbol: 'frxEURCHF', description: 'Euro vs Swiss Franc' },
    { symbol: 'frxEURAUD', description: 'Euro vs Australian Dollar' },
    { symbol: 'frxEURCAD', description: 'Euro vs Canadian Dollar' },
    { symbol: 'frxEURNZD', description: 'Euro vs New Zealand Dollar' },
    { symbol: 'frxGBPJPY', description: 'Pound vs Japanese Yen' },
    { symbol: 'frxGBPCHF', description: 'Pound vs Swiss Franc' },
    { symbol: 'frxGBPAUD', description: 'Pound vs Australian Dollar' },
    { symbol: 'frxGBPCAD', description: 'Pound vs Canadian Dollar' },
    { symbol: 'frxGBPNZD', description: 'Pound vs New Zealand Dollar' },
    { symbol: 'frxAUDJPY', description: 'Aussie vs Japanese Yen' },
    { symbol: 'frxAUDCHF', description: 'Aussie vs Swiss Franc' },
    { symbol: 'frxAUDCAD', description: 'Aussie vs Canadian Dollar' },
    { symbol: 'frxAUDNZD', description: 'Aussie vs Kiwi' },
    { symbol: 'frxCADJPY', description: 'Canadian Dollar vs Yen' },
    { symbol: 'frxCADCHF', description: 'Canadian Dollar vs Franc' },
    { symbol: 'frxCHFJPY', description: 'Swiss Franc vs Yen' },
    { symbol: 'frxNZDCAD', description: 'Kiwi vs Canadian Dollar' },
    { symbol: 'frxNZDCHF', description: 'Kiwi vs Swiss Franc' },
    { symbol: 'frxNZDJPY', description: 'Kiwi vs Japanese Yen' },
    { symbol: 'frxNZDSGD', description: 'Kiwi vs Singapore Dollar' },
    { symbol: 'frxUSDMXN', description: 'USD vs Mexican Peso' },
    { symbol: 'frxUSDPLN', description: 'USD vs Polish Zloty' },
    { symbol: 'frxUSDSEK', description: 'USD vs Swedish Krona' },
    { symbol: 'frxUSDSGD', description: 'USD vs Singapore Dollar' },
    { symbol: 'frxUSDTRY', description: 'USD vs Turkish Lira' },
    { symbol: 'frxUSDZAR', description: 'USD vs South African Rand' },
    { symbol: 'frxEURTRY', description: 'Euro vs Turkish Lira' },
    { symbol: 'frxEURZAR', description: 'Euro vs South African Rand' },
    { symbol: 'frxGBPTRY', description: 'Pound vs Turkish Lira' },
    { symbol: 'frxGBPZAR', description: 'Pound vs South African Rand' },
    { symbol: 'frxXAUUSD', description: 'Gold vs US Dollar' },
    { symbol: 'frxXAGUSD', description: 'Silver vs US Dollar' },
    { symbol: 'cryBTCUSD', description: 'Bitcoin vs US Dollar' },
    { symbol: 'cryETHUSD', description: 'Ethereum vs US Dollar' },
    { symbol: 'cryLTCUSD', description: 'Litecoin vs US Dollar' },
    { symbol: 'cryBCHUSD', description: 'Bitcoin Cash vs USD' },
    { symbol: 'cryADAUSD', description: 'Cardano vs US Dollar' },
    { symbol: 'cryALGUSD', description: 'Algorand vs US Dollar' },
    { symbol: 'cryAVAUSD', description: 'Avalanche vs US Dollar' },
    { symbol: 'cryBATUSD', description: 'Basic Attention Token' },
    { symbol: 'cryBNBUSD', description: 'Binance Coin vs USD' },
    { symbol: 'cryDOTUSD', description: 'Polkadot vs US Dollar' },
    { symbol: 'cryDSHUSD', description: 'Dash vs US Dollar' },
    { symbol: 'cryEOSUSD', description: 'EOS vs US Dollar' },
    { symbol: 'cryETCUSD', description: 'Ethereum Classic vs USD' },
    { symbol: 'cryFILUSD', description: 'Filecoin vs US Dollar' },
    { symbol: 'cryIOTUSD', description: 'IOTA vs US Dollar' },
    { symbol: 'cryLNKUSD', description: 'Chainlink vs US Dollar' },
    { symbol: 'cryMKRUSD', description: 'Maker vs US Dollar' },
    { symbol: 'cryMTCUSD', description: 'Ethereum (alternate)' },
    { symbol: 'cryNEOUSD', description: 'Neo vs US Dollar' },
    { symbol: 'cryOMGUSD', description: 'OmiseGO vs US Dollar' },
    { symbol: 'crySOLUSD', description: 'Solana vs US Dollar' },
    { symbol: 'cryTRXUSD', description: 'TRON vs US Dollar' },
    { symbol: 'cryXLMUSD', description: 'Stellar vs US Dollar' },
    { symbol: 'cryXMRUSD', description: 'Monero vs US Dollar' },
    { symbol: 'cryXRPUSD', description: 'Ripple vs US Dollar' },
    { symbol: 'cryZECUSD', description: 'Zcash vs US Dollar' },
    { symbol: 'cryBTCETH', description: 'Bitcoin vs Ethereum' },
    { symbol: 'cryBTCLTC', description: 'Bitcoin vs Litecoin' }
];

// ========== CLIENTE DERIV (WEBSOCKET) ==========
...
// Middleware CORS para permitir requisições de qualquer origem (ajuste conforme necessário)
...
app.use(express.static('public')); // para servir o frontend HTML

// Inicializa cliente Deriv
const derivAppId = process.env.DERIV_APP_ID || '1089';
const derivToken = process.env.DERIV_TOKEN || '1Jd2sESxdZ24Luv';
const derivClient = new DerivClient(derivAppId, derivToken, true);

// Conecta à Deriv (assíncrono, mas não precisa esperar para iniciar o servidor)
derivClient.connect().catch(err => {
    console.error('Erro ao conectar na Deriv:', err.message);
});

// Inicializa bot do Telegram (se as variáveis estiverem definidas)
let telegramBot = null;
if (process.env.TELEGRAM_TOKEN && process.env.TELEGRAM_CHAT_ID) {
    telegramBot = new TelegramBot(process.env.TELEGRAM_TOKEN, { polling: false });
} else {
    console.warn('Variáveis TELEGRAM_TOKEN e/ou TELEGRAM_CHAT_ID não definidas. Mensagens não serão enviadas.');
}

// Rota para listar símbolos
...
app.post('/api/analyze', async (req, res) => {
    ...
    try {
        // Busca candles para todos os timeframes
        const candlesByTF = await derivClient.getAllTimeframes(symbol, CANDLE_COUNT);

        // Verifica se algum timeframe falhou
        const errors = Object.entries(candlesByTF)
            .filter(([, value]) => value.error)
            .map(([tf, value]) => `${tf}: ${value.error}`);
        if (errors.length > 0) {
            return res.status(500).json({ error: 'Erro ao obter dados', details: errors });
        }

        // Constrói o objeto de entrada para a análise
        const dadosAnalise = {};
        const tfMapping = {
            'M5': '5m',
            'M15': '15m',
        ...
        for (const [tfOriginal, candles] of Object.entries(candlesByTF)) {
            const tfDestino = tfMapping[tfOriginal];
            if (!tfDestino) continue; // ignora timeframes não mapeados

            const ultimoPreco = candles.length > 0 ? candles[candles.length - 1].close : 0;
            dadosAnalise[tfDestino] = {
                candles: candles,
                preco: ultimoPreco
            };
        }
        ...
        // Envia para o Telegram, se configurado
        if (telegramBot && process.env.TELEGRAM_CHAT_ID) {
            const mensagem = formatarParaTelegram(resultado, symbol);
            telegramBot.sendMessage(process.env.TELEGRAM_CHAT_ID, mensagem, { parse_mode: 'Markdown' })
                .catch(err => console.error('Erro ao enviar mensagem Telegram:', err));
        }
